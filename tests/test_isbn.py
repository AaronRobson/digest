...
class TestCheck(unittest.TestCase):
    def test_isbn_prefix(self):
        ...
        self.assertEqual(check('ISBN 0-596-00281-', give_checksum=True), 5)

    def test_isbn_13(self):
        self.assertTrue(check('978-0-306-40615-7'))
        self.assertEqual(check('978-0-306-40615-', give_checksum=True), 7)

    def test_isbn_10_x_checksum(self):
        self.assertTrue(check('1903397-26-x'))
        self.assertEqual(check('1903397-26-', give_checksum=True), 'X')

    def test_isbn_10_numeric_checksum(self):
        self.assertTrue(check('0-313-20060-2'))
        self.assertEqual(check('0-313-20060-', give_checksum=True), 2)
